...
_DEFAULT_MARKETDATA_KEY = 'YOUR_XTS_MARKETDATA_KEY'
_DEFAULT_MARKETDATA_SECRET = 'YOUR_XTS_MARKETDATA_SECRET'
...
def parse_args():
    ...
    parser.add_argument('--max-position-per-side', type=int, default=0,
                        help='Circuit breaker: max net position per side before halting entries (0 = no limit)')
    ...
    parser.add_argument('--hedge-ratio', type=float, default=0,
                        help='Hedge %% of primary qty on COMPLETE fill (40 = 40%%, 0 = disabled)')
    parser.add_argument('--partial-hedge-ratio', type=float, default=0,
                        help='Hedge %% of primary qty on PARTIAL fill (40 = 40%%, 0 = disabled)')
...
def main():
    ...
    config = GridConfig.from_args(
        ...
        max_position_per_side=args.max_position_per_side,
