...
# Add parent directory to path for Daily imports
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

# Import Zerodha related modules from Daily directory
try:
...
class FrequentTickerPerformanceAnalyzer:
    ...
    def __init__(self, user_name="Sai", days_back=3):
        ...
        self.output_dir = "/Users/maverick/PycharmProjects/India-TS/Daily/analysis/results"
