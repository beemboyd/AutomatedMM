#!/usr/bin/env python3
"""
VSR Ticker Persistence Analysis - Prior Two Weeks (July 29 - Aug 10, 2025)
Analyzes Excel efficiency reports for the period before Aug 11
"""
...
def analyze_prior_period_persistence():
    """Analyze VSR persistence for July 29 - Aug 10 period"""
    
    # Load the Excel efficiency reports for prior period
    prior_file1 = '/Users/maverick/PycharmProjects/India-TS/Daily/analysis/Efficiency/Eff_Analysis_long_20250811_20250729.xlsx'
    prior_file2 = '/Users/maverick/PycharmProjects/India-TS/Daily/analysis/Efficiency/Eff_Analysis_long_20250812_20250730.xlsx'
    
    # Read the data
    df_prior1 = pd.read_excel(prior_file1)  # July 29 - Aug 11
    df_prior2 = pd.read_excel(prior_file2)  # July 30 - Aug 12
    
    # Since these overlap, we'll use the first one (July 29 - Aug 11) as primary
    df_long = df_prior1.copy()
    ...
    print("Analysis Period: July 29 - August 11, 2025 (Two Weeks Before Current Analysis)")
    print("Data Source: VSR Efficiency Reports (Hourly Scans)")
    print("="*120)
    
    print("\n" + "="*100)
    print("LONG SIGNALS ANALYSIS - PRIOR PERIOD")
    print("="*100)
    ...
    if len(extreme_long) > 0:
        print(f"\n\n{'='*100}")
        print("EXTREME PERSISTENCE (75+ ALERTS) - PRIOR PERIOD")
        print("These tickers appeared in almost every hourly scan during July 29 - Aug 11")
        print("="*100)
    ...
    # Summary Statistics
    print(f"\n\n{'='*100}")
    print("SUMMARY STATISTICS - PRIOR PERIOD (July 29 - Aug 11)")
    print("="*100)
    ...
    print(f"\n\n{'='*100}")
    print("COMPARISON: PRIOR PERIOD (Jul 29-Aug 11) vs CURRENT PERIOD (Aug 11-22)")
    print("="*100)
