...
RESULTS_DIR = os.path.join(os.path.dirname(SCRIPT_DIR), "results-s-h")  # Short hourly results directory
...
def main():
    ...
    try:
        ...
        if results:
            ...
            # Skip HTML generation for hourly version
            ...
            # No HTML report for hourly version
        else:
            ...
            logger.info(f"No high probability SHORT patterns found. Empty output file created at {excel_file}")
