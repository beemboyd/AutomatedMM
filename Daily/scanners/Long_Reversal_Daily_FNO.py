...
RESULTS_DIR = os.path.join(os.path.dirname(SCRIPT_DIR), "FNO", "Long")  # Changed output directory
HTML_DIR = os.path.join(os.path.dirname(SCRIPT_DIR), "FNO", "Long")     # Changed HTML directory
