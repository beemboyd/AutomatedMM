...
RESULTS_DIR = os.path.join(os.path.dirname(SCRIPT_DIR), "FNO", "Long", "Liquid")
HTML_DIR = os.path.join(os.path.dirname(SCRIPT_DIR), "FNO", "Long", "Liquid")
...
def generate_html_report(filtered_df, output_file, scanner_file):
    ...
    <head>
        ...
        <title>Long Reversal Daily FNO Liquid Filter - {formatted_date}</title>
        <style>
            body {{
    ...
    <body>
        <h1>Long Reversal Daily FNO Liquid Filter with Sector Information</h1>
...
# -----------------------------
def main():
    """Main function to filter FNO Liquid tickers for higher probability LONG reversals with sector information"""
    logger.info("Long Reversal Daily FNO Liquid filter with Sector Information")
...
if __name__ == "__main__":
    # Print banner
    print("\n===================================")
    print("Long Reversal Daily FNO Liquid Filter with Sector")
    print("==================================")
