...
- **Job Manager Dashboard**: http://localhost:9090 - Central control for all jobs and dashboards
...
## Job Manager Dashboard Details

### Overview:
The Job Manager Dashboard provides centralized control and monitoring for all India-TS scheduled jobs and dashboards from a single web interface.

### Features:
- **Unified Control**: Manage all 20+ scheduled jobs and 4 dashboards from one place
- **Real-time Status**: View current status of all jobs and dashboards
- **Job Actions**: Reload, restart, or stop any scheduled job
- **Dashboard Actions**: Start, restart, or stop any dashboard
- **Statistics Panel**: Summary cards showing running, successful, and error counts
- **Auto-refresh**: Updates every 10 seconds

### Access:
- **URL**: http://localhost:9090
- **Start Command**: `./Daily/Health/start_job_manager.sh`
- **Stop Command**: `./Daily/Health/stop_job_manager.sh`
- **Location**: `/Daily/Health/job_manager_dashboard.py`

### Capabilities:
- Controls both launchctl-managed jobs/dashboards and script-based dashboards
- Provides separate sections for scheduled jobs and dashboards
- Shows port information for each dashboard
- Enables/disables action buttons based on current status
