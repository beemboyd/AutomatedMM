...
## Issue
The restart functionality for the Market Regime Dashboard (port 8080) and Health Dashboard (port 7080) was not working properly from the Job Manager Dashboard (port 9090).
